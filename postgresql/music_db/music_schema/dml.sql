...
INSERT INTO music_schema."Rating"(
  "id",
  "rate"
)
VALUES(
...
INSERT INTO music_schema."Song"("artist", "title", "difficulty", "level", "released")
VALUES
...
-- insert record into the Rating table.
INSERT INTO music_schema."Rating"("id", "rate")
VALUES
  ( 1, 2),
  ( 2, 1),
  ( 3, 4),
